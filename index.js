...
monitor.on('cpu', cpuMetrics)
monitor.on('memory', memoryMetrics)
monitor.on('http', httpInMetrics)
monitor.on('https', httpInMetrics)
monitor.on('https-outbound', httpOutMetrics)
monitor.on('http-outbound', httpOutMetrics)
monitor.on('eventloop', EventLoopMetrics(prometheus))
monitor.on('gc', GCMetrics(prometheus))
